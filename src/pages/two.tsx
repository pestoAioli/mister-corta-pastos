  ...
  return (
    <>
      ...
      <Html center style={{ maxHeight: size.height, width: size.width < 700 ? size.width - 20 : size.width / 2, overflowY: 'scroll' }}>
        ...
        <h2>Beefy version:</h2>
        <p>After dropping out of art school at age 19, I met an artist named <a href="https://claudyjongstra.com/">Claudy Jongstra</a> while I was working at a restaurant down the street from the SFMOMA. After ignoring my work for 30 minutes and chatting with her, she invited me to come work for her at her farm and studio in Friesland, The Netherlands.
          5 months later I bought a one-way ticket to Barcelona with my best friend and the rest of my life began. We stayed in the city for a while before travelling to a small village in Bajo Aragon named La Fresneda, where we would spend almost a month together getting to know the locals and exploring the surrounding areas of the Matarranya river, before he had to return to California for school.
          ...
          This experience not only validated me as an artist, but further taught me that only through taking risks and venturing into completely unknown worlds, will you begin to figure out who you are.
          {/*eslint-disable-next-line react/no-unescaped-entities*/}
          ...
          A huge tragedy befell my family and I returned to California to be with them, when Covid-19 happened. It was then, in the midst of this situation that I finally asked myself if I was happy with the path I was on. The answer was no. The pieces I created were an expression of my innermost feelings, and trying to monetize them was actually just depressing and stripped the process of its beauty and intimacy. One of my best friends and now mentor, Nico, had been trying to convince me to learn to code since New York, but since
          {/*eslint-disable-next-line react/no-unescaped-entities*/}
